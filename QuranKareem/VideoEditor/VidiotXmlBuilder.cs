...
namespace QuranKareem
{
    ...
    internal static class VidiotXmlBuilder
    {
        ...
        {
            sb.Append("<item class_id=\"23\" tracking_level=\"0\" version=\"1\"><px class_id=\"25\" class_name=\"model::VideoTrack\" tracking_level=\"1\" version=\"1\" object_id=\"_")
              .Append(object_id++)
        ...
        {
            sb.Append("<item><px class_id_reference=\"25\" object_id=\"_")
              .Append(object_id++)
        ...
        {
            sb.Append("<mAudioTracks><count>2</count><item_version>1</item_version><item><px class_id=\"46\" class_name=\"model::AudioTrack\" tracking_level=\"1\" version=\"1\" object_id=\"_")
              .Append(object_id++)
              .Append("\"><Track object_id=\"_")
              .Append(object_id++)
        ...
        {
            sb.Append("<mRender class_id=\"47\" tracking_level=\"0\" version=\"1\"><px class_id=\"48\" tracking_level=\"1\" version=\"5\" object_id=\"_")
              .Append(object_id++)
